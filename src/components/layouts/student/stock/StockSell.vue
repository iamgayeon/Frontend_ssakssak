        ...
        <div class="modal-container p-4 shadow-lg rounded bg-white">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <div class="mt-2">
                        <button class="btn btn-outline btn-outline-primary me-2 pt-0 pb-1"
                            @click="plusQuantity(5)">+5</button>
                        <button class="btn btn-outline-primary btn-color-primary me-2 pt-0 pb-1"
                            @click="plusQuantity(10)">+10</button>
                        <button class="btn btn-outline-primary btn-color-primary me-2 pt-0 pb-1"
                            @click="plusQuantity(20)">+20</button>
                        <button class="btn btn-outline-primary btn-color-primary pt-0 pb-1"
                ...
                <div class="mb-3">
                    ...
                    <span class="fw-bold">{{ sellTotal }} 씨드</span>
                </div>
            </div>
